 ...
 */
public class SilentInstallInstalling extends Activity {
    private static final String LOG_TAG = SilentInstallInstalling.class.getSimpleName();
...
//    private PackageInstaller.SessionCallback mSessionCallback;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // final File sourceFile = new File("/data/data/com.android.packageinstaller/files/package5498839571189756554.apk");
